...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lightPosLoc, lightPos.x + movelight, lightPos.y + movelight, lightPos.z + movelight);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.0f, 1.0f, 0.0f); // Specular doesn't have full effect on this object's material
        ...
        model = glm::mat4(1); //seteamos la martiz
        glUniformMatrix4fv(glGetUniformLocation(lightingShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.0f, 0.0f, 1.0f); // Specular doesn't have full effect on this object's material
        ...
        //Poke 3 dorada
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 1.0f, 1.0f, 1.0f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.980f, 1.0f, 0.321f);
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, lightPos+movelight);
